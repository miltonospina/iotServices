...
const server = new opcua.OPCUAServer({
    port: 4863, // the port of the listening socket of the server
...
function post_initialize() {
    ...
    function construct_my_address_space(server) {
        ...
        let variable2 = Math.round(Math.random()*100,0);

        namespace.addVariable({
            componentOf: device,
            nodeId: "ns=1;s=t|SERVIDORES_SERVIDOR1::Programa_Caldera/PV_ELLIOT.SI", // some opaque NodeId in namespace 4
